...
def new_run():
    ...
    Label(f17,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def new_route():
    ...
    Label(f15,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def new_bus():
    ...
    Label(f13,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def new_operator():
    ...
    Label(f11,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def ticketShow(row):
    ...
    Label(f4,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
        ...
        if type(busch)!=int:
            ...
            def booked(fare):
                ...
                if 1:
                    ...
                    for i in e6.get():
                        if i not in mob:
                            showerror("Invalid","Enter a valid Mobile Number!!")
                            break
                    # if(len(e6.get())!=10):
                    #     showerror("Invalid","Enter a valid Mobile Number!!")
                    for i in e7.get():
                        if i not in mob:
                            showerror("Invalid","Enter a vaild age!!")
                            break
                    if len(e7.get())>2:
                        showerror("Invalid","Enter a vaild age!!")
...
def check_booked_seat(f2):
    f7=Frame(f2,relief='groove',bd=5)
    ...
    Label(f7,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
...
def add_bus():
    ...
    Label(f9,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
...
def tab2():
    ...
    Label(f2,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
    f3 =Frame(f2,pady=20)
...
def tab1():
    ...
    Label(f1,text = "Bus Booking Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red' ).pack()
    Label(f1,text = "Name : Hrishikesh Bhatt", font=("Arial",15),fg='blue',anchor = S,pady=50).pack()
    Label(f1,text = "Enrollment No. : 211B139", font=("Arial",14),fg='blue',anchor = S).pack()
    Label(f1,text = "Mobile : 9024611775", font=("Arial",14),fg='blue',anchor = S, pady=50).pack()
    Label(f1,text = "Submitted to : Dr. Mahesh Kumar", font=("Arial",20), bg = 'deep sky blue', fg = 'red' , pady = 10).pack()
